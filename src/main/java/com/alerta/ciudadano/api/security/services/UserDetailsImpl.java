...
public class UserDetailsImpl implements UserDetails {
	...
	public UserDetailsImpl(Long id, String username, String email, String password,String nombre,
			String apellido, String docIdentidad, String fecNacimiento, String nroTelefono, String institucion, boolean estado,
	...
	public static UserDetailsImpl build(User user) {
		...
		return new UserDetailsImpl(user.getId(), user.getUsername(), user.getEmail(), user.getPassword(),
				user.getNombre(), user.getApellido(), user.getDocIdentidad(),user.getFecNacimiento(), user.getNroTelefono(),
