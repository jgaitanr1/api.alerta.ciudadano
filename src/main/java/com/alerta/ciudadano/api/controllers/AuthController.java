package com.alerta.ciudadano.api.controllers;
...
import com.alerta.ciudadano.api.payload.request.ChangePasswordRequest;
import com.alerta.ciudadano.api.payload.request.LoginRequest;
import com.alerta.ciudadano.api.payload.request.SignupRequest;
import com.alerta.ciudadano.api.payload.response.MessageResponse;
import com.alerta.ciudadano.api.payload.response.UserInfoResponse;
import com.alerta.ciudadano.api.repository.RoleRepository;
import com.alerta.ciudadano.api.repository.UserRepository;
import com.alerta.ciudadano.api.security.jwt.JwtUtils;
import com.alerta.ciudadano.api.security.services.UserDetailsImpl;
...
public class AuthController {
	...
	public ResponseEntity<?> authenticateUser(@Valid @RequestBody LoginRequest loginRequest) {
		...
		return ResponseEntity.ok().header(HttpHeaders.SET_COOKIE, jwtCookie.toString()).body(
				new UserInfoResponse(userDetails.getId(), userDetails.getUsername(), userDetails.getEmail(),
						...
						userDetails.getFecNacimiento(), userDetails.getNroTelefono(), userDetails.getInstitucion(), userDetails.isEstado(), roles));
	}
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
		...
		User user = new User(signUpRequest.getUsername(), signUpRequest.getEmail(),
				...
				signUpRequest.getInstitucion(),  signUpRequest.isEstado());
