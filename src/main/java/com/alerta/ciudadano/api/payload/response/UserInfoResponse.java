package com.alerta.ciudadano.api.payload.response;
...
public class UserInfoResponse {
	...
	public UserInfoResponse(Long id, String username, String email, String nombre, String apellido,
			String docIdentidad, String fecNacimiento, String nroTelefono, String institucion, boolean estado, List<String> roles) {
		this.id = id;
